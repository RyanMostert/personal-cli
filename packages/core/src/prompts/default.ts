...
## Core Directives
- **Reasoning First:** For every request, first think step-by-step about the problem, the context, and the best approach. Provide this reasoning mononlogue wrapped in <thought> tags before any tool calls or final response.
